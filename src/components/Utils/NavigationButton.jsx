 ...
 * @param {string} iconPosition - The position of the icon ('before' or 'after').
 */
// eslint-disable-next-line react/prop-types
const NavigationButton = ({ buttonText, href, icon: Icon, className, iconPosition = 'after' }) => {
  const iconClasses = `w-[18px] h-[18px] transition-all duration-[0.3s] ease-in-out relative ${iconPosition === 'before' ? 'right-0 group-hover:right-1' : 'left-0 group-hover:left-1'}`;
